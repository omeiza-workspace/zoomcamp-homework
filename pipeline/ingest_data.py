...
@click.option('--pg_table', default='yellow_taxi_data', help='Target table name')
def run(pg_user, pg_pass, pg_host, pg_port, pg_db, year, month, chunksize, pg_table):
    ...
    for df_chunk in df_iter:
        ...
        if first:
            ...
            first = False
            print(f"Table {pg_table} created.")
    ...
    print(f'done ingesting to {pg_table})')
